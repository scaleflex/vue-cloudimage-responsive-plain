  ...
  data() {
    return {
      config: {
        ...
        ignoreStyleImgSize:this.cloudImageConfig.ignoreStyleImgSize,
        saveNodeImgRatio:this.cloudImageConfig.saveNodeImgRatio,
        detectImageNodeCSS:this.cloudImageConfig.detectImageNodeCSS,
        processOnlyWidth:this.cloudImageConfig.processOnlyWidth,
        xs: '(max-width: 575px)',
        sm: '(min-width: 576px)',
        md: '(min-width: 768px)',
        lg: '(min-width: 992px)',
