    ...
    <CloudImageProvider v-bind:cloudImageConfig="cloudImageConfig">
      ...
      <div style=" background: #fff">
        <section class="container ready-to-start">
          ...
          <ul>
            <li>
              <strong>Resize large images</strong> to the size needed by your design and
            ...
            <li>
              Efficiently
              <strong>lazy load images</strong> to speed initial page load and save bandwidth
            </li>
            <li>
